...
#             datetime(2018, 1, 28)]
date_list = [datetime(2018, 1, 30), datetime(2018,2, 15), datetime(2018, 3, 1), datetime(2017, 3, 15),
             datetime(2018, 3, 31), datetime(2018, 4, 15), datetime(2017, 4, 30), datetime(2018, 5, 15),
             datetime(2018, 5, 31)]
